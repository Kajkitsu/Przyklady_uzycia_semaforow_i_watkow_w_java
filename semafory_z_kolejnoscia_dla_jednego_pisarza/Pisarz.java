...
public class Pisarz extends Thread {
    ...
    public Pisarz(Biblioteka biblioteka, int ID, Semaphore semaphorePisarza,Semaphore semaphoreCzytaczy) {
    ...
    public void run() {
        while (true) {
            ...
            try {
                semaphorePisarza.acquire(); //zajecie semafora. Od tego momentu zaczyna sie sekcja krytyczna.
            ...
            semaphoreCzytaczy.release(); //zwolnienei semafora. W tym momencie konczy sie sekcja krytyczna.
